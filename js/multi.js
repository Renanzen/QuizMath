...
function geraValor() {
    valor1 = Math.floor(Math.random() * 50 + 1);
    valor2 = Math.floor(Math.random() * 15 + 1);
...
function escolherBotao() {
    ...
    tress = Math.floor(Math.random() * valor2 * valor1);
    quatroo = Math.floor(Math.random() * valor2 * valor1);
